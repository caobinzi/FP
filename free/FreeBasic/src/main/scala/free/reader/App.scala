...
object FreeApp extends App {
  ...
  def interpreter = {
    val interpreter0: PRG0 ~> Store = ( Reader2Store compose Console) or Crudinterpreter
    val interpreter1: PRG1 ~> Store = (Reader2Store compose Printer) or interpreter0
    val interpreter2: PRG2 ~> Store = (Reader2Store compose PPPrinter) or interpreter1
